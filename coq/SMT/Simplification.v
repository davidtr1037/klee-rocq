...
Definition normalize_binop_bv40 op (ast1 ast2 : smt_ast Sort_BV40) :=
  AST_BinOp Sort_BV40 op ast1 ast2
.
...
Definition normalize_binop op (s : smt_sort) (ast1 ast2 : smt_ast s) : smt_ast s :=
  let f :=
    ...
    | Sort_BV40 => normalize_binop_bv40
...
Definition normalize_cmpop_bv40 op (ast1 ast2 : smt_ast Sort_BV40) : smt_ast Sort_BV1 :=
  AST_CmpOp Sort_BV40 op ast1 ast2
.
...
Definition normalize_cmpop op (s : smt_sort) (ast1 ast2 : smt_ast s) : smt_ast Sort_BV1 :=
  let f :=
    ...
    | Sort_BV40 => normalize_cmpop_bv40
...
Definition normalize_ite_bv1 (cond ast1 ast2 : smt_ast Sort_BV1) :=
  ...
  | _ =>
      ...
      | _ => AST_ITE Sort_BV1 cond ast1 ast2
      end
  end
.
...
Definition normalize_ite_bv40 cond (ast1 ast2 : smt_ast Sort_BV40) :=
  AST_ITE Sort_BV40 cond ast1 ast2
.
...
Definition simplify_binop_bv40 op (ast1 ast2 : smt_ast Sort_BV40) :=
  AST_BinOp Sort_BV40 op ast1 ast2
.
...
Definition simplify_cmpop_bv40 op (ast1 ast2 : smt_ast Sort_BV40) :=
  AST_CmpOp Sort_BV40 op ast1 ast2
.
...
Proof.
  ...
  { rewrite Int40.eq_sym. reflexivity. }
...
Proof.
  ...
  {
    remember (Int40.eq (smt_eval_ast m Sort_BV40 ast1) (smt_eval_ast m Sort_BV40 ast2)) as b.
    destruct b; reflexivity.
  }
  {
...
Lemma equiv_smt_expr_ite_property_1 : forall ast1 ast2,
  equiv_smt_expr
    ...
    (Expr Sort_BV1
       (AST_ITE Sort_BV1 ast1 (AST_Const Sort_BV1 Int1.zero) ast2)).
Proof.
  intros ast1 ast2.
  apply EquivExpr.
  intros m.
...
Lemma equiv_smt_expr_ite_property_4 : forall ast1 ast2,
  equiv_smt_expr
    ...
    (Expr
      Sort_BV1
      (AST_ITE Sort_BV1 ast1 ast2 (AST_Const Sort_BV1 Int1.one))).
Proof.
  intros ast1 ast2.
  apply EquivExpr.
  intros m.
