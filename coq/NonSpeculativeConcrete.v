...
Proof.
  ...
  }
  {
    ...
    destruct di1 as [n1 | n1 | n1 | n1 | n1 | n1 | n1 | n1 | n1]; try discriminate Heval.
    destruct dv2 as [di2 | | ] eqn:Edv2.
    {
      destruct di2 as [n2 | n2 | n2 | n2 | n2 | n2 | n2 | n2 | n2]; (
        destruct dv3 as [di3 | | ] eqn:Edv3; try discriminate Heval;
        try (destruct H7; apply Is_Poison);
        (
          destruct di3 as [n3 | n3 | n3 | n3 | n3 | n3 | n3 | n3 | n3]; (
...
Proof.
  ...
  inversion Heval2; subst.
  {
    ...
    {
      inversion Hu; subst.
      destruct di1 as [n1 | n1 | n1 | n1 | n1 | n1 | n1 | n1 | n1]; discriminate Heval.
    }
    { discriminate Heval. }
